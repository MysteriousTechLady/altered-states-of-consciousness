...
freq_left = 220  # Base frequency for left ear (Hz)
freq_right = freq_left + 12  # Right ear frequency to create a 12 Hz binaural beat (Alpha range)
...
output_file = os.path.join(downloads_folder, "alpha_wave_12hz_30min.wav")
